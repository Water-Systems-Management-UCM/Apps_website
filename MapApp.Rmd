...
CSV_data <- CSV_data%>%group_by(NAME,Year)%>%mutate(`Total land`=sum(Total_Land)/1000,`Total water`=sum(TW)/1000)%>%ungroup()
...
Data[Data$variable=="AW",]$variable = "Applied water by acre"
